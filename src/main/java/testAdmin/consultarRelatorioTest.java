...
import pageObjects.relatorioPage;
import pageObjects.web;

public class consultarRelatorioTest {
	...
	public void test() {
		...
		//Invocando métodos da página relatorio Page
		new relatorioPage(navegador).selecionarMenuRelatorio().clicarBotaoPesquisarPaginaRelatorio();
			}
