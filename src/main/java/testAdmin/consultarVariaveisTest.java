...
import pageObjects.variaveisPage;
import pageObjects.web;

public class consultarVariaveisTest  {
	...
	//Invocando métodos da página variaveis Page
	new variaveisPage(navegador).selecionarMenuAuxiliar().clicarMenuRegistros().selecionarUmRegistro();
